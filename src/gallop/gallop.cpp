...
void start_runtime() 
{
	...
	//app->add_strategy(0, std::make_shared<hft_2_strategy>("SHFE.rb2306", 0.0058F, 120, 10, 3));
	...
	app->add_strategy(3, std::make_shared<hft_3_strategy>("SHFE.rb2306", 9, 0.58F, 1.28F, 1.5F, 2));
	app->run_to_close();
...
void start_evaluate(const char* code,const std::vector<uint32_t>& all_trading_day)
{
	...
	*/
	...
	stra_list.emplace_back(new hft_3_strategy("SHFE.rb2301", 9, 0.58F, 0.88F, 1.58F, 3));
	//stra_list.emplace_back(new hft_3_strategy("SHFE.rb2305", 9, 0.58F, 1.28F, 2));
